...
int main()
{
   int secret_code[4]; // will be used to construct the secret code of the code maker
   ...
   for(int r = 1; r <= 12; r++) // this loop exucutes creates the rounds
   {
        ...
        if(white_pins == 4)
        {
            cout << "You broke the secret code in " << r << " rounds." << endl;;
            return 0;
        }
        else
        {
   ...
   cout << "You couldn't break the code in 12 rounds. It has been proven that you are stupid :)" << endl;
   return 0;
}
